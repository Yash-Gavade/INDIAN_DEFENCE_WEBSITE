          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                  <h2 class="h-ultra"><a href="sign.php"></a>Sign In for Administrator and Guest</a></h2>
              </div>
            ...
            <div class="col-lg-6">
              <div class="form-wrapper">
                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
					  ...
					  <input type="submit" value="Administrator" class="btn btn-skin btn-block btn-lg" style="width:40%;"></a>


	                  <a href="soldier/login.php"><input type="submit" value="Guest" class="btn btn-skin btn-block btn-lg" style="width:40%;margin right:30px;">
