                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-4 shadow">                       
                                ...
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="gender" <?php if($gender == ""  ){ echo "checked"; } ?>  value="" >
                                </div>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="LOCATION" <?php if($LOCATION == ""  ){ echo "checked"; } ?>  value="" >
                                </div>
