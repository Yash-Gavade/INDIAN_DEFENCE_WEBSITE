...
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
  ...
  if( !empty($email) && !empty($pass) ){
    ...
    $sql_query = "SELECT * FROM SOLDIERS WHERE email='$email' && password = '$pass'  ";
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    ...
                                    <h4 class="text-center">Hello, Soldier</h4>
                                ...
                                <p class=" login-form__footer">Not a Soldier? <a href="../admin/login.php" class="text-primary">Log-In </a>as Admin now</p>
                                </form>
                            </div>
                        </div>
                    </div>
